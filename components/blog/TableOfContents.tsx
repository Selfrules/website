...
export default function TableOfContents({ className = '' }: TableOfContentsProps) {
  ...
  return (
    <motion.nav
      ...
      initial="hidden"
      animate="visible"
      className={`sticky top-24 bg-white dark:bg-gray-900 border-4 border-black rounded-brutal shadow-brutal p-6 ${className}`}
              ...
              <button
                ...
                className={`text-left w-full px-3 py-2 rounded-brutal-sm border-2 border-black text-sm transition-all ${
                  isActive
                    ...
                    : 'bg-transparent text-brutalist-text-light dark:text-brutalist-text-dark hover:bg-gray-100 dark:hover:bg-gray-800'
                }`}
              >
                {heading.text}
              </button>
