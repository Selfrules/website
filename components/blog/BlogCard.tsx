      ...
      <article className="lg:col-span-3">
        <Link href={`/${locale}/blog/${post.slug}`}>
          <motion.div
            ...
            className="group bg-deep-purple border-brutal border-black shadow-brutal hover:shadow-brutal-lg rounded-brutal-lg p-brutal-lg md:p-brutal-xl min-h-[300px] md:min-h-[350px] flex flex-col justify-between cursor-pointer relative overflow-hidden"
          >
            {/* Decorative Circle */}
