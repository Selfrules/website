        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <button
                onClick={onClose}
                className="absolute top-4 right-4 p-2 hover:bg-brutalist-text-light/10 rounded-brutal transition-colors z-10"
              ...
              <div className="p-8">
                ...
                <blockquote className="mb-8">
                  <p className="text-xl md:text-2xl text-brutalist-text-light/90 leading-relaxed font-medium">
                    &quot;{testimonial.quote}&quot;
                  </p>
                </blockquote>
